 ...
 *
 * Note some ideas were borrowed from LibTomMath and OpenSSL.
 * All of the code is original or ported from LibTomMath [no code was ported from OpenSSL].
 *
 * -- Tom St Denis
 *
 * Porting to Micropython copyright (c) 2016-2019 Damiano Mazzella
*/
